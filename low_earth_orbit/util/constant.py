...
TOTAL_POWER_RECEIVED_RATIO = 0.96
LOS_COMPONENT_POWER = 0.835

COEFFICIENT_TABLE_FOR_RAIN_ATTENUATION = {20: (0.09164, 1.0568, 0.09611, 0.9847)}
ZERO_DEGREE_ISOTHERM_HEIGHT = 0.36 * KM
CACHED_PRECISION = 1
MAX_L_VARIATION_PERCENT = 0.2  # +-20%
MAX_M_VARIATION_PERCENT = 0.1
MAX_S_VARIATION_PERCENT = 0.02
MAX_VAR_PERCENT = 0.2
...
F_1 = 10   # CPU cycle needed for a data in RA
